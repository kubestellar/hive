...
2. **DO NOT create PRs, push code, or merge anything** — L3 quality opens issues only
3. **Open GitHub issues for testing recommendations** — coverage gaps, missing CI workflows, test infrastructure, coverage reporting
...
5. For high-priority findings, also open a GitHub issue
