...
func withMockDeviceFlow(handler func(req *http.Request) (*http.Response, error), fn func()) {
	orig := deviceFlowClient
	deviceFlowClient = &http.Client{Transport: &mockTransport{handler: handler}}
	defer func() { deviceFlowClient = orig }()
	fn()
}
