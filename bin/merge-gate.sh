...
AI_AUTHORS = {os.environ.get('PROJECT_AI_AUTHOR', ''), 'copilot-swe-agent[bot]', 'github-actions[bot]', 'app/github-actions', 'dependabot[bot]', 'app/kubestellar-hive', 'kubestellar-hive[bot]'} - {''}
